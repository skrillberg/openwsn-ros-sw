...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vagrant/catkin_ws/install/${idir}'.  Ask the maintainer 'vagrant <bkilberg@berkeley.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vagrant/catkin_ws/install/lib;/home/vagrant/catkin_ws/devel/lib;/opt/ros/indigo/lib)
