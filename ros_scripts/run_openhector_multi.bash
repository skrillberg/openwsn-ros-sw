...
(gnome-terminal -e "bash -c \"rosrun openwsn_ros node_handler.py 10; exec bash\"")

sleep 1
cd /home/muminovic/Desktop/openwsn-ros/openwsn-sw/software/openvisualizer 

(gnome-terminal -e "bash -c \"sudo scons runweb --sim --simCount=10 --root='emulated1'; exec bash\"")
term1=$!
